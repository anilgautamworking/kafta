...
class ClickConsumer
{
    ...
    private $group = 'click_group';
    private $consumer;
    private $batchSize = 1000;

    public function __construct($consumer = 'click_worker_1', $batchSize = 1000)
    {
    ...
    /**
     * Process messages from the clicks stream
     */
    public function process()
    {
        echo "Starting Click Consumer...\n";
        ...
        while (true) {
            try {
                ...
                error_log("Error in click consumer loop: " . $e->getMessage());
    ...
    private function processBatch(array $messages)
    {
        ...
        echo "Processing batch of " . count($events) . " click events...\n";

        // Aggregate clicks by ad_id and date
        $aggregated = [];
        ...
        try {
            ...
            $this->db->rollback();
            error_log("Error processing click batch: " . $e->getMessage());
            throw $e;
        }
    }
}
